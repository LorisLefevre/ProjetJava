...
public class Auteur extends Personne {
    ...
    public String toString() {
        return "Modèle.CoucheAccèsDonnées.ClassesMétier.Auteur{" +
                "Nom='" + Nom + '\'' +
                ", Prenom='" + Prenom + '\'' +
    ...
    public static void main(String[] args) {
        // Test de la classe Modèle.CoucheAccèsDonnées.ClassesMétier.Auteur

        // Test du constructeur par défaut
        Auteur auteur1 = new Auteur();
        System.out.println("Modèle.CoucheAccèsDonnées.ClassesMétier.Auteur par défaut :");
        ...
        System.out.println("\nModèle.CoucheAccèsDonnées.ClassesMétier.Auteur initialisé :");
...
// Analyser la chaîne de date pour créer un objet Date
        ...
        System.out.println("\nModèle.CoucheAccèsDonnées.ClassesMétier.Auteur après modification :");
        System.out.println(auteur1);
