...
public class Livre
{
    ...
    {
        return "ClassesMétier.Livre{" +
                "ID=" + ID +
                ", Titre='" + Titre + '\'' +
                ", ClassesMétier.Auteur='" + Auteur + '\'' +
                ", ClassesMétier.Editeur='" + Editeur + '\'' +
                ", Annee=" + Annee +
                ", ISBN='" + ISBN + '\'' +
    ...
    public void Afficher()
    {
        ...
        System.out.println("ClassesMétier.Auteur : " + Auteur);
        System.out.println("ClassesMétier.Editeur : " + Editeur);
